...
public class ParameterValidator {
    ...
    public void validate(String input, Set<Parameter> parameters) throws ParameterTypeException, ParameterRangeException, ParameterScopeException, JaqpotSerializationException, ParameterFormationException {

        Map<String, Object> parameterMap = null;

        if (input != null && parameters == null) {
            throw new ParameterTypeException("Passed parameters that are not neaded");
        }
        if (input != null && parameters != null) {
            //Check the formation of parameters
            parameterMap = parameterValidator.checkFormation(input);
            //For each mandatory parameter in stored algorithm, check if it exists in user input
            parameterValidator.checkParameterExistence(parameterMap, parameters);
            for (Map.Entry<String, Object> entry : parameterMap.entrySet()) {
                //Check the parameter id if any fiven wrong
                Parameter parameterFromBase = parameterValidator.checkParamatersId(entry, parameters);
                //Check the parameter type if right
                ValueType parameterType = parameterValidator.checkParameterType(entry, parameterFromBase);
                if (parameterType != ValueType.VALID_JSON_DESCRIBED) {
                    //Check Parameter Allowed Values
                    parameterValidator.checkParameterAllowedValues(entry, parameterFromBase);
                    //Check min values
                    parameterValidator.checkMinValue(entry, parameterFromBase);
                    //Check max values
                    parameterValidator.checkMaxValue(entry, parameterFromBase);
                }
...
//
//                //Check for not right parameters id's
...
//                }
//
//                ValueType parameterValueType = parameter.getValueType();
//
...
//                            }
//                        } else {
//                            throw new ParameterTypeException("Parameter with id: '" + parameterId + "' must be an Array of alphanumeric values");
//                        }
//                        break;
//                    default:
//                        break;
